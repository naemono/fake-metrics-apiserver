...
import (
	...
	custommetricstorage "github.com/naemono/fake-metrics-apiserver/pkg/registry/custom_metrics"
	externalmetricstorage "github.com/naemono/fake-metrics-apiserver/pkg/registry/external_metrics"
	sampleprovider "github.com/naemono/fake-metrics-apiserver/pkg/fake-adapter/provider"
)
...
func TestExternalMetricsAPI(t *testing.T) {
	...
	prov, _ := sampleprovider.NewFakeProvider(nil, nil, false, metrics.NewHPAPollDurationObserver())
